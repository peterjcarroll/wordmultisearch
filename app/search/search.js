...
.controller('SearchPageController', function ($scope, $sce, $cookies, $anchorScroll, $location, $window) {
    ...
    var getRhinoSpikeLink = function(lang, search) {
      var langCode = {'cmn': '13', 'deu': '3', 'eng': '1', 'epo': '22', 'fra': '6', 'jpn': '4', 'ron': '21', 'spa': '2'};
    ...
    var getForvoLink = function(lang, search) {
      var langCode = {'cmn': 'zh', 'deu': 'de', 'eng': 'en', 'epo': 'eo', 'fra': 'fr', 'jpn': 'ja', 'ron': 'ro', 'spa': 'es'};
    ...
    var getLingueeLink = function(lang, search) {
      var langCode = {'cmn': 'english-chinese', 'deu': 'english-german', 'fra': 'english-french', 'jpn': 'english-japanese', 'ron': 'english-romanian', 'spa': 'english-spanish'};
    ...
    var getGoogleImagesLink = function(lang, search) {
      var langCode = {'cmn': 'com.hk', 'deu': 'de',  'eng': 'com', 'fra': 'fr', 'jpn': 'jp', 'ron': 'ro', 'spa': 'es'};
    ...
    var getGoogleTranslateLink = function(lang, search) {
      var langCode = {'cmn': 'zh-CN', 'deu': 'de', 'epo': 'eo', 'fra': 'fr', 'jpn': 'ja', 'ron': 'ro', 'spa': 'es'};
    ...
    var isSupported = function(tab, lang){
      var langSupport = {
        'rhinospike': 'cmn deu eng epo fra jpn ron spa',
        'forvo': 'cmn deu eng epo fra jpn ron spa',
        'tatoeba': 'cmn deu eng epo fra jp ron spa',
        'linguee': 'cmn deu fra jpn ron spa',
        'googleimages': 'cmn deu eng fra jpn ron spa',
        'googletranslate': 'cmn deu epo fra jpn ron spa',
        'transdict': 'cmn deu epo fra jpn ron spa',
        'monodict': 'cmn deu eng epo fra jpn ron spa'
      };
